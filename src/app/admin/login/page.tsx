 ...
 * Must be wrapped in <Suspense> for Next.js 16 static prerendering —
 * useSearchParams() suspends during CSR bailout and requires a Suspense boundary.
 */
function LoginForm() {
  ...
  return (
    <Card className="w-full max-w-sm">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-xl">FixCare Admin</CardTitle>
      </CardHeader>
      <CardContent>
